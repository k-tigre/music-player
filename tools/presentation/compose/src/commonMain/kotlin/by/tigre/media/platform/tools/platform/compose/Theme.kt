...
fun staticColorScheme(darkTheme: Boolean, contrast: ContrastPreference): ColorScheme =
    when {
        darkTheme -> when (contrast) {
            ContrastPreference.Default -> darkScheme
            ContrastPreference.Medium -> darkMediumContrastScheme
            ContrastPreference.High -> darkHighContrastScheme
        }

        else -> when (contrast) {
            ContrastPreference.Default -> lightScheme
            ContrastPreference.Medium -> lightMediumContrastScheme
            ContrastPreference.High -> lightHighContrastScheme
        }
    }
...
fun AppTheme(
    ...
    contrast: ContrastPreference = ContrastPreference.Default,
    content: @Composable () -> Unit
) {
    val colorScheme = platformColorScheme(darkTheme, dynamicColor)
        ?: staticColorScheme(darkTheme, contrast)
