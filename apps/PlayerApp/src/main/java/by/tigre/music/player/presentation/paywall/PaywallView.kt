...
class PaywallView(
    ...
    override fun Draw(modifier: Modifier) {
        ...
        ModalBottomSheet(onDismissRequest = component::dismiss, modifier = modifier) {
            Column(
    ...
    @Composable
    private fun SubscriptionPlans(plusProduct: ProductUi?, proProduct: ProductUi?) {
        SubscriptionProduct(plusProduct, stringResource(R.string.paywall_plus), stringResource(R.string.paywall_plus_benefits))
        SubscriptionProduct(proProduct, stringResource(R.string.paywall_pro), stringResource(R.string.paywall_pro_benefits))
    }

    @Composable
    private fun SubscriptionProduct(product: ProductUi?, tier: String, benefits: String) {
        ...
        offers.forEach { offer ->
            val recommended = product?.productId == "music_pro" && offer.basePlanId == "yearly"
            Card(
